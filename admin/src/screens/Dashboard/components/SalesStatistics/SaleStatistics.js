      ...
      <div className="card mb-4 shadow-sm">
        <article className="card-body">
          ...
          <iframe
            ...
            src="https://charts.mongodb.com/charts-fashionshop-soddq/embed/charts?id=646984bc-a471-4053-8faa-ad936c8895ae&maxDataAge=300&theme=light&autoRefresh=true&attribution=false"
          ></iframe>
        </article>
      </div>
    </div>
